...
<ul class="info">
  ...
  <?php if(!$userid){ ?>
    <li class="user"><a href="/common_template_0323/signin.php"><i class="ri-user-fill"></i></a></li>
  <?php } else { ?>
    <li class="loggedIn">
      <span><?=$userid?>님</span>&nbsp;|&nbsp;<a href="/common_template_0323/php/logout.php">Logout</a>
    </li>
  <?php } ?>
</ul>